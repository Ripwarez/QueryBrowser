  ...
  <table class="table table-striped">
    ...
    <?php foreach ($results as $result) : ?>
      <tr>
        <?php if (!empty($deleteURI)) : ?>
          <td class="update">
            <a href="<?php echo $updateURI; ?>"><span class="glyphicon glyphicon-pencil"></span></a>
          </td>
        <?php endif; ?>
        ...
        <?php if (!empty($deleteURI)) : ?>
          <td class="delete">
            <a href="<?php echo $deleteURI; ?>"><span class="glyphicon glyphicon-remove"></span></a>
          </td>
        <?php endif; ?>
      </tr>
    <?php endforeach; ?>
