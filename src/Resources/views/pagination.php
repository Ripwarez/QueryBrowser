...
<ul class="pagination">
	<?php if ($firstPage): ?>
		<li><a href="javascript:void(0);" onclick="QBR.gotoPage('<?php echo $id; ?>', <?php echo $firstPage; ?>);" title="First">&laquo;&laquo;</a></li>
	<?php else: ?>
		<li class="disabled"><a href="javascript:void(0);">&laquo;&laquo;</a></li>
	<?php endif; ?>

	<?php if ($previousPage): ?>
		<li><a href="javascript:void(0);" onclick="QBR.gotoPage('<?php echo $id; ?>', <?php echo $previousPage; ?>);">&laquo</a></li>
	<?php else: ?>
	...
	<?php if ($nextPage): ?>
		<li><a href="javascript:void(0);" onclick="QBR.gotoPage('<?php echo $id; ?>', <?php echo $nextPage; ?>);">&raquo;</a></li>
	<?php else: ?>
		<li class="disabled"><a href="javascript:void(0);">&raquo;</a></li>
	<?php endif; ?>

	<?php if ($lastPage): ?>
		<li><a href="javascript:void(0);" onclick="QBR.gotoPage('<?php echo $id; ?>', <?php echo $lastPage; ?>);">&raquo;&raquo;</a></li>
	<?php else: ?>
